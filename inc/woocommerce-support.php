...
/**
 * Ensure WooCommerce's classic shortcode-based Checkout AND Cart are
 * used instead of the block editor versions — classic checkout has far
 * broader payment-gateway plugin compatibility (gateway setup happens
 * separately from this build), and WooCommerce defaults the Cart page
 * to the block-based cart by default, which renders entirely different
 * markup that this theme's cart styling doesn't target. See CLAUDE.md.
 */
 ...
 * the page chrome consistently. No sidebar, no default breadcrumb —
 * this theme's own page-hero (below) replaces both the default "Shop"
 * title and the breadcrumb trail.
 */
...
/**
 * Branded page-hero banner for the Shop archive (and product category/
 * tag archives) — 'woocommerce_before_main_content' only fires on these
...
function mor_woocommerce_shop_hero() {
	...
	<section class="page-hero">
		<div class="container">
			<p class="label-caps"><?php esc_html_e( 'Shop', 'mor-websites' ); ?></p>
			<h1><?php esc_html_e( 'The Store', 'mor-websites' ); ?></h1>
			<p class="page-hero__tagline"><?php esc_html_e( 'New arrivals and everyday staples for men and women — every piece ships from Accra.', 'mor-websites' ); ?></p>
		</div>
	</section>
	<?php
}
