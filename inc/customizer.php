...
function mor_theme_mod_defaults() {
	return array(
		'company_name'    => 'DigitalDrum Networks',
		// REPLACE with the real store email in Customizer > Store Details.
		'company_email'   => 'info@digitaldrumnetworks.example',
		// REPLACE with the real store phone in Customizer > Store Details.
		'company_phone'   => '+233 00 000 0000',
		'company_address' => 'H/No. D 20/6, Near Commercial Bank, Osu, Nii Amo Street, Accra, Ghana',
	);
}
