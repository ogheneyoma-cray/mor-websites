		...
		<div class="site-branding">
			<a class="site-branding__link" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php echo esc_attr( mor_get_store_detail( 'company_name' ) ); ?>">
				...
				if ( $custom_logo_id ) {
					...
					?>
					<img class="site-branding__logo" src="<?php echo esc_url( MOR_THEME_URI . '/assets/images/logo.svg' ); ?>" width="38" height="38" alt="<?php echo esc_attr( mor_get_store_detail( 'company_name' ) ); ?>">
					<?php
				}
				?>
			</a>
		...
		<nav id="site-navigation" class="main-navigation" aria-label="<?php esc_attr_e( 'Primary', 'mor-websites' ); ?>">
			...
			if ( has_nav_menu( 'primary' ) ) {
				...
				<ul>
					...
					<?php endif; ?>
					<li><a href="<?php echo esc_url( home_url( '/about/' ) ); ?>"><?php esc_html_e( 'About', 'mor-websites' ); ?></a></li>
