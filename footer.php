	...
	<div class="container">
		<div class="footer-grid">
			<div>
				...
				<p><?php esc_html_e( 'Practical, reliable technology support for homes and businesses in Accra.', 'mor-websites' ); ?></p>
			</div>
			...
			<div>
				...
				<ul>
					...
					<?php if ( ! mor_woocommerce_is_missing() && function_exists( 'wc_get_page_id' ) ) : ?>
						<li><a href="<?php echo esc_url( get_permalink( wc_get_page_id( 'shop' ) ) ); ?>"><?php esc_html_e( 'Services', 'mor-websites' ); ?></a></li>
					<?php endif; ?>
					<li><a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>"><?php esc_html_e( 'Contact', 'mor-websites' ); ?></a></li>
					<li><a href="<?php echo esc_url( home_url( '/shipping-policy/' ) ); ?>"><?php esc_html_e( 'Service Delivery Policy', 'mor-websites' ); ?></a></li>
					...
					<li><a href="<?php echo esc_url( home_url( '/refunds-policy/' ) ); ?>"><?php esc_html_e( 'Refunds & Cancellation Policy', 'mor-websites' ); ?></a></li>
				</ul>
			</div>
